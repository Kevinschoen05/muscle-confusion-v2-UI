<template>
    <form @submit.prevent="handleSubmit()" class="mt-4 flex flex-col">
        ...
        <input class="border w-4/12" type="email" name="email" v-model="this.email" required>

        <label for="email">Password:</label>
        <input class="border w-4/12" type="password" name="password" v-model="this.password" required>
