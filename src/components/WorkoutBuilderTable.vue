    ...
    <li
        ...
        <div class="flex align-items-start mr-0 lg:mr-5">
            <div>
                ...
                <div v-else>
                    <InputNumber  class="" id="set-number" v-model="newReps" :min="1" :step="1" pattern="\d*"
                    showButtons />
        ...
        <div class="mt-3 lg:mt-0">
            ...
            <Button icon="pi pi-pencil" class="p-button-rounded p-button mr-2"
               @click="editSet = true"></Button>
        </div>
</li>
</template>
